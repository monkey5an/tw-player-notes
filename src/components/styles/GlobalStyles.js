...
export const baseStyles = css`
  ...
  * {
  ...
  html,
  body {
    font-family: 'Bookinsanity Remake', serif;
    font-size: 18px;
  ...
  blockquote {
    ...
    color: rgb(116, 129, 141) !important;
    margin: 1rem 0px 24px;
    padding: 1.2rem 2rem 1rem 1.2rem !important;
  ...
  blockquote strong em, blockquote strong, blockquote em {
    font-family: 'Scaly Sans' !important;
    font-size: 0.98rem !important;
  }

  blockquote strong, blockquote strong em {
  ...
  .showFrontLine .item .active > a {
    ...
    border-style: solid none solid solid;
    border-width: 1px 0px 1px 1px;
    background-color: #554263 !important;
    color: #fff;
  }
  ...
  tbody tr:nth-child(odd) {
    background-color: rgba(235, 230, 238, 0.4) !important;
  }
  ...
  :is(.heading1, .heading2, .heading3, .heading4, .heading5, .heading6) {
  ...
  strong em {font-family:'Bookinsanity Remake Smbld Itlc'; font-weight: 700 !important;
